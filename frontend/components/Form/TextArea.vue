  ...
  <div class="relative">
    <textarea 
      ...
      class="p-3 rounded-lg 
        ...
        text-secondary-900 dark:text-secondary-dark-100 font-medium placeholder:text-secondary-300 
        outline-none resize-none box-border border-2 border-transparent
        placeholder:text-sm
        dark:placeholder:text-secondary-dark-500"
      :class="[size ? size : 'w-full h-[150px]', { '!border-red-500 dark:!border-[#e05151]': !valid }]"
    ></textarea>
    <div 
      class="absolute -bottom-1 flex items-center transition ease-out duration-150"
